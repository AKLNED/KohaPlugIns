...
<!-- Top Navigation Bar -->
    <nav class="navbar">
        <ul>
            ...
            <li><a href="https://eakl.neduet.edu.pk/cgi-bin/koha/svc/auth/googleopenidconnect">
              Log In / Sign Up</a></li>
            <li><br>            
            <li></li>
      </ul>
	...
	<header class="header">
  <div class="container">
    <h1 class="site-title">EAK Library Koha Plugins</h1>
  </div>
</header>

<!-- Old Header Section with image-->
<!--     <header class="header"> -->
<!--         <div class="container"> -->
		
<%--            <p><img src="<%=request.getContextPath()%>/common/kohaOpacHeader.png" width="1217" height="149" align="absmiddle"></p> --%>
<%--           <img src="<%=request.getContextPath()%>/common/kohaOpacHeader.png" --%>
<!--          alt="Koha OPAC Header" -->
<!--          class="responsive-header-img"> -->
         
<!--       </div> -->
<!--     </header> -->
	
	<!-- Older Header Section with image-->
    <!--<header class="header">
        <div class="container">
            <img src="kohaOpacHeader.png" alt="Header Image" class="responsive-header-img">
        </div>
    </header>-->